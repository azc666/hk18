      ...
      <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
        <a href="/product/101" class="group">
          <div class="w-full overflow-hidden rounded-lg h-80 bg-gray-50">
            ...
            <img src="/assets/Staff/mexico_sbc_display.jpg"
              class="mt-6 -ml-2 scale-105 group-hover:opacity-75">
            @elseif (auth()->user()->username === 'HK46')
            <img src="/assets/staff/london_sbc_display.jpg"
              class="mt-6 -ml-2 scale-105 group-hover:opacity-75">
            @else
            <img src="/assets/staff/sbc_display.jpg"
              class="mt-6 -ml-2 scale-105 group-hover:opacity-75">
            @endif
          </div>
        ...
        <a href="/product/107" class="group">
          <div class="w-full overflow-hidden rounded-lg h-80 bg-gray-50">
            @if (auth()->user()->username === 'HK34')
              <img src="/assets/staff/bogota_sfyi_display.jpg"
                class="mt-6 group-hover:opacity-75">
            @elseif (auth()->user()->username === 'HK35' || auth()->user()->username === 'HK42')
              <img src="/assets/Staff/mexico_sfyi_display.jpg"
                class="mt-6 group-hover:opacity-75">
            @elseif (auth()->user()->username === 'HK46')
              <img src="/assets/staff/london_sfyi_display.jpg"
                class="mt-6 group-hover:opacity-75">
            @else
              <img src="/assets/staff/sfyi_display.jpg"
                class="mt-6 group-hover:opacity-75">
            @endif
          </div>
          <h3 class="mt-6 text-2xl text-center text-gray-100 font-helmd hover:opacity-75"><span
        ...
        <a href="/product/104" class="group">
          <div class="w-full overflow-hidden rounded-lg h-80 bg-gray-50">
          @if (auth()->user()->username === 'HK34')
            <img src="/assets/staff/bogota_sbcfyi_display.jpg"
          ...
          @elseif (auth()->user()->username === 'HK46')
            <img src="/assets/staff/london_sbcfyi_display.jpg"
              class="mt-6 ml-4 scale-110 group-hover:opacity-75">
          @else
            <img src="/assets/staff/sbcfyi_display.jpg"
              class="mt-6 group-hover:opacity-75">
          @endif
        </div>
          <h3 class="mt-6 text-2xl text-center text-gray-100 font-helmd hover:opacity-75"><span
