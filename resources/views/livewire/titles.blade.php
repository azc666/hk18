	...
	<div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
		<div class="flex items-center justify-between">
			...
			<div class="relative flex items-start">
				...
				{{-- <div class="w-24 h-10 p-2 mr-4 text-sm bg-white border border-gray-300 rounded-md text-bluegray-500">
			...
			<table class="min-w-full divide-y divide-gray-200">
				<thead class="bg-white">
					<tr>
						<th scope="col" class="px-6 py-3 text-left">
							<div class="flex items-center">
								<button wire:click="sortBy('type')"
									class="text-xs tracking-wider uppercase font-helmd text-hkcolor focus:outline-none">Title
									Type</button>
						...
						<th scope="col" class="px-6 py-3 text-left">
							<div class="flex items-center">
								<button wire:click="sortBy('updated_at')"
									class="text-xs tracking-wider uppercase font-helmd text-hkcolor focus:outline-none">
									Last Updated</button>
						...
						<th scope="col" class="px-6 py-3 text-xs tracking-wider text-center uppercase font-helmd text-hkcolor">
							id
						</th>

						<th scope="col"
							class="relative px-6 py-2 text-xs tracking-wider text-right uppercase font-helmd text-hkcolor">
							<button wire:click="$emit('openModal', 'create-title')" {{-- <button wire:click="createShowModal"
								type="button" --}}
				...
				<tbody class="divide-y divide-gray-200 bg-gray-50 hover:bg-gray-100">
					...
					<tr>
						<td class="w-3/12 px-6 py-2 whitespace-no-wrap">
							<div class="flex items-center">
								<div class="flex-shrink-0 w-10 h-10">
									...
									@else
									<img class="w-10 h-10 rounded-full" src="https://www.gravatar.com/avatar/?d=mp&f=y" alt="">
									@endif
								</div>
								<div class="ml-4">
						...
						<td class="px-6 py-4 text-xs text-center whitespace-nowrap">
							{{ $title->id }}
							{{-- @if ($title->active === 1)
							<span class="px-4 py-1 text-xs font-bold text-green-800 bg-green-100 rounded-full">Active</span>
							@else
						...
						<td class="px-2 py-1 text-right whitespace-nowrap">
							...
							{{-- <a href="#" class="text-sm font-semibold uppercase text-hkcolor hover:text-indigo-500">Edit</a> --}}
						</td>
					</tr>
					@endforeach
				</tbody>
	...
	<jet-dialog-modal wire:model="modalFormVisible">
		...
		<x-slot name="content">
			{{-- <div class="mt-4">
				...
				<jet-input wire:model.debounce.800ms="type" id="type" class="block w-full mt-1" type="text" name="type" />
			...
			<div class="mt-4">
				...
				<jet-input wire:model.debounce.800ms="title" id="title" class="block w-full mt-1" type="text" name="title" />
				@error('title')
				<span class="text-sm text-red-500">{{ $message }}</span>
				@enderror
			</div>
