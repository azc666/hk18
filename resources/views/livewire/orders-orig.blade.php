                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left">
                            <div class="flex items-center">
                                ...
                                <x-sort-icon field="location" :sortField="$sortField" :sortAsc="$sortAsc" />
                            </div>
                        </th>
                        <th scope="col" class="px-6 py-3 text-left">
                            <div class="flex items-center">
                                <button wire:click="sortBy('location_name')"
                ...
                <tbody class="bg-gray-50 divide-y divide-gray-200 hover:bg-gray-100">
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-1 whitespace-nowrap text-right">
                            <button wire:click="updateShowModal({{ $order->confirmation }})" class="inline-flex items-center px-4 py-1 bg-hkcolor border border-transparent rounded-full font-bold text-xs text-white
                            ...
                            focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                                <span class=""> {{ __('Confirmation') }}</span>
                            </button>
