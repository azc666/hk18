{{-- <div> --}}
    ...
    <div class="w-11/12 mx-auto mt-6 mb-6 border border-gray-200 rounded-md">
        <div class="ml-2 mr-2 mx-auto p-4 m-4 bg-gray-100 rounded-md border-2 border-gray-200 shadow-md">
            <div class="flex justify-between relative">
                ...
                <div>
                    ...
                    <form method="post" action="postDate" autocomplete="off">
                        @csrf
                        <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak class="flex">


                            <label for="datepicker" class="font-bold mt-4 text-gray-700 text-lg mr-4">Please ship this order
                                to arrive
                                by:</label>
                            <div class="relative">
            ...
            <div class="pt-6 pb-6 text-center">
                If <strong>"RUSH"</strong> is selected, all items in this cart will be produced and shipped on an ASAP
                expedited basis irrespective of date requested. <br>
                <strong>"RUSH"</strong> Partner Business Cards in this cart will have Digital cards produced and shipped
                while
    ...
    <div class="text-align-right mx-auto mb-4 -mt-2">
        ...
        {{-- <a href="{{ route('destroyrow', ['rowId' => $row->rowId]) }}"><span --}} {{-- <a href="/cart"><span
              class="text-white text-sm font-bold uppercase">Proceed to Checkout</span> --}} {{-- </button> --}} </div>
            </form>
    {{ request('date') }}
