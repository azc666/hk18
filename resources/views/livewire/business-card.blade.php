<div>
  ...
  <div class="relative grid grid-cols-12">
    ...
    <div class="relative col-span-7 col-start-1">
      ...
      @if ($product->id === 101 || $product->id === 102 || $product->id === 103)
      <img src="{{ '/assets/mpdf/bc2_template_withText.jpg' }}" class="absolute inset-x-0 max-w-xl shadow-xl inset-y-14"
        alt="...">
    ...
    <div
      ...
      <form wire:submit.prevent="submitForm" autocomplete="off"
        class="p-2 space-y-4 border rounded-md bg-slate-100 border-slate-500">
        @csrf
