<x-action-section>
    <x-slot name="title">
        <span class="text-xl text-white font-helmd">{{ __('Two Factor Authentication') }}</span>
    </x-slot>

    <x-slot name="description">
        <div class="text-white font-hellt">{{ __('Add additional security to your account using two factor
            authentication.') }}
        </div>
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4">
            ...
            <x-input id="code" type="text" name="code" class="block w-1/2 mt-1" inputmode="numeric" autofocus
